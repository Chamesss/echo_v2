...
describe("withholdAuthorMessages", () => {
  it("blanks the departed author's messages across every channel cache, leaving others", () => {
    ...
    const c2 = qc.getQueryData<EchoMessage[]>(messagesKey(ws, "c2"))!;
