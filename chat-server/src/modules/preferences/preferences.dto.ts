 ...
 * `chat-front/src/features/appearance/schema.ts` — there is no shared package
 ...
 *
 * Keep in sync with `chat-front/src/styles/themes.css` (one block per id) and
 * the registry in `chat-front/src/features/appearance/themes.ts`.
 */
