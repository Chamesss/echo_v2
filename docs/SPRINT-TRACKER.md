# Sprint Tracker — Internal Echo MVP
...
| `Dockerfile` (server) | ops | ✅ | `echo-server/Dockerfile` (multi-stage, pnpm deploy) + `.dockerignore` excludes `.env` |
