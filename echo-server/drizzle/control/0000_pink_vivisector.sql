...
CREATE TABLE "tenant_catalog" (
	...
	CONSTRAINT "tenant_catalog_schema_name_unique" UNIQUE("schema_name")
);
--> statement-breakpoint
CREATE TABLE "users" (
	"id" text PRIMARY KEY NOT NULL,
...
ALTER TABLE "tenant_catalog" ADD CONSTRAINT "tenant_catalog_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
